    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                sharedPreferences.edit().putLong(SP_KEY_TD, seekBar.getProgress() * 1000 * 1000).apply();
            }
        });
...
//        mFile = new File(getActivity().getExternalFilesDir(null), "pic.jpg");
        ...
        if (Build.MODEL.equals("MI 5s Plus")) {
            timeDelay = sharedPreferences.getLong(SP_KEY_TD, 12 * 1000 * 1000);
            isSensorUseRTCTime = false; // TODO Xiaomi 9 is true
        } else if (Build.BRAND.toLowerCase().equals("xiaomi")) {
            timeDelay = sharedPreferences.getLong(SP_KEY_TD, 12 * 1000 * 1000);
            isSensorUseRTCTime = true;
        } else if (Build.BRAND.equals("samsung")) {
            // do nothing
            timeDelay = sharedPreferences.getLong(SP_KEY_TD, 11 * 1000 * 1000);
        }
